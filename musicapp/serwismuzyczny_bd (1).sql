...
--
-- Host: 127.0.0.1
-- Czas generowania: 14 Gru 2015, 21:35
...
(35, 'The Resistance', 'dasdsa', '0000-00-00', '0.00', 0, 35, 1, 1),
(36, 'sdas', 'dasdas', '0000-00-00', '0.00', 0, 36, 1, 1),
(37, 'dsads', 'dasds', '0000-00-00', '0.00', 0, 37, 1, 1);
...
(11, 'Syreny', 25),
(12, 'piosenka', 35),
(13, 'Song for someone', 16),
(14, 'The Miracle', 16),
(15, 'Raised By Wolves', 16),
(16, 'Volcano', 16),
(17, 'Every Breaking Wave', 16);
...
--
ALTER TABLE `album`
  MODIFY `id_album` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
--
...
--
ALTER TABLE `band`
  MODIFY `id_band` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
--
...
--
ALTER TABLE `track`
  MODIFY `id_track` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
